...
!(function (t, e) {
	...
	if (
		((et.requestsCount = 0), (et.requests = {}), 'undefined' != typeof document)
	)
	...
	var rt =
		...
		st = (function (t) {
			...
			function i(t) {
				var r;
				return (
					e(this, i), ((r = n.call(this, t)).supportsBinary = !t.forceBase64), r
				);
			}
			return (
				r(i, [
	...
	function mt(t) {
		var e = [],
			...
			r = t;
		return (
			(r.data = kt(n, e)), (r.attachments = e.length), { packet: r, buffers: e }
		);
	}
	function kt(e, n) {
		if (!e) return e;
